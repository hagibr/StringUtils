...
*   **Simple Regex Matching**: A lightweight, non-recursive regular expression engine supporting `.` (any char), `*` (zero or more), `+` (one or more), `^` (start of string), and `$` (end of string).
